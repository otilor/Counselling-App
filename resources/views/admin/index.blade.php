            ...
            <header id="page-topbar">
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                        ...
                        <span class="badge badge-danger badge-pill">{{ count($applications) }}</span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                                ...
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                        <span class="badge badge-pill badge-danger">New {{ count($applications) }}</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <form method="POST" name = "logout" action="{{ route('logout') }}">
                                {{ csrf_field() }}
                                <a class="dropdown-item" href="javascript:document.logout.submit()"><i class="mdi mdi-logout font-size-16 align-middle mr-1"></i> Logout</a>
                                </form>
                            </div>
                        </div>
